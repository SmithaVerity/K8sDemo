...
az network vnet create  --resource-group $RESOURCE_GROUP   --location $REGION_NAME   --name $VNET_NAME  --address-prefixes 10.0.0.0/24  --subnet-name $SUBNET_NAME   --subnet-prefixes 10.0.0.0/25
...
--service-cidr 10.2.0.0/29 \
--dns-service-ip 10.2.0.4 \
